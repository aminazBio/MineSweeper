...
def print_board():
    ...
    #in these numberings, we have two different parts: one is before number 10 which because of availability of one digit we don't have any problem, but the other one is numbers which are higher than 10 with two digits which was making problems for spacings and I solved them according to my code below there:   
    t=[]
    p=[]
    h=0
